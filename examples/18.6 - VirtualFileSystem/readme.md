...
## Upstream Example: [18.2 - Pipelined](https://github.com/handsonscala/handsonscala/tree/master/examples/18.2%20-%20Pipelined):
Diff:
```diff
...
+        HashActor.send(p.subRelativeTo(src))
       }
     )
