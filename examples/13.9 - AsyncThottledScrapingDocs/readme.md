# Example 13.9 - AsyncThottledScrapingDocs
...
## Upstream Example: [13.6 - ParallelScrapingDocs](https://github.com/handsonscala/handsonscala/tree/master/examples/13.6%20-%20ParallelScrapingDocs):
Diff:
```diff
diff --git a/13.6 - ParallelScrapingDocs/ScrapingDocs.sc b/13.9 - AsyncThottledScrapingDocs/ScrapingDocs.sc
index 863b4c3..c543cb9 100644
--- a/13.6 - ParallelScrapingDocs/ScrapingDocs.sc	
+++ b/13.9 - AsyncThottledScrapingDocs/ScrapingDocs.sc	
@@ -1,12 +1,26 @@
